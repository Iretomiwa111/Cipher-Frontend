    ...
    >
      <div className="max-w-6xl mx-auto text-white">
        ...
        <div className="text-left mb-12" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
          ...
          <h1 className="text-4xl font-bold mb-4">What Do We Provide?</h1>
          <p className="text-base opacity-90">
            Our service combines ease and security, guiding you through a seamless process to restore your account. We also offer in-depth threat investigations to ensure your personal data remains protected.
          </p>
        </div>
